...
public class Efetivo extends Funcionario{
	...
	public void mostrarFuncionarioEfetivo() {
		...
		if(this.tempoDeEmpresaEmMeses/12 >= 1) {
			...
			System.out.printf("Tempo de empresa: %d anos e %d meses.%n", tempoDeEmpresa, (this.tempoDeEmpresaEmMeses%12));
		} else {
			System.out.println("Tempo de empresa: " + this.tempoDeEmpresaEmMeses + " meses.");
		}
	}
}
